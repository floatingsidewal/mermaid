      ...
      <html>
        <head>
          ...
          <style>
            ...
            .title { font-family: Arial; font-size: 18px; font-weight: bold; margin-bottom: 20px; }
          </style>
        </head>
        <body>
...
${item.diagram}
    ...
    const outputPath = join(__dirname, 'screenshots', `${item.name}.png`);
    await page.screenshot({ path: outputPath, fullPage: true });

    console.log(`  ✓ Saved to screenshots/${item.name}.png`);
  }
